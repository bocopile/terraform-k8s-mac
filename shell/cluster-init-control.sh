...
# Control Cluster Initialization Script
...
echo "=========================================="
echo "Starting Control Cluster initialization..."
echo "=========================================="

# Check if this is control-master-0
if hostname | grep -q "control-master-0"; then
  MASTER_IP=$(hostname -I | awk '{print $1}')

  echo "Initializing Control Cluster with:"
  ...
  echo "=========================================="
  echo "Control Cluster initialization completed!"
